...
export class NpcMovementController {
  ...
  fleeConfig: Record<string, any>;
  stuck: Record<string, any>;
  fleeMemory: Record<string, any>;
  speedConfig: Record<string, number>;
   ...
   */
  getCurrentSpeed(state: string): number {
   ...
   */
  calculateVelocity(state: string, stateController: any, delta: number): { x: number; y: number } {
   ...
   */
  calculateFleeingVelocity(stateController: any, delta: number): { x: number; y: number } {
   ...
   */
  applyVelocity(velocity: { x: number; y: number }): void {
    // Stocker la vélocité
   ...
   */
  capVelocity(velocity: { x: number; y: number }, state: string): { x: number; y: number } {
