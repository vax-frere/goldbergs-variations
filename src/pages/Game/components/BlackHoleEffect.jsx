...
const DEFAULT_PARTICLE_SIZE_RANGE = [0.12, 0.6];
...
const createParticleTexture = () => {
  ...
  gradient.addColorStop(0.4, "rgb(11, 219, 177)");
  gradient.addColorStop(0.8, "rgba(166, 46, 46, 1)");
  gradient.addColorStop(1, "rgba(237, 15, 15, 1)");
