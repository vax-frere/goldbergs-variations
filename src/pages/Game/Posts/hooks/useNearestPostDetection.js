...
import { activeNodeRef } from "../../../../pages/ExportForceGraphPage/Graph/Node/hooks/useNodeProximitySync";
...
const useNearestPostDetection = (posts) => {
  ...
  useEffect(() => {
    ...
    import(
      "../../../../pages/ExportForceGraphPage/Graph/Node/hooks/useNodeProximitySync"
    ).then((module) => {
